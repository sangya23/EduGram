...
// Your table has: id, user_id, title, subject, priority, due_date, is_done
...
try {
    ...
    // GET - Fetch all assignments for current user
    if ($method === 'GET') {
    ...
    // PUT - Update assignment (toggle completion)
    elseif ($method === 'PUT') {
        $data = json_decode(file_get_contents('php://input'), true);
        ...
        // Toggle completion using is_done column
